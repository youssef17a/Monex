    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 rounded-2xl bg-gradient-to-r from-slate-900 to-slate-900/60 border border-slate-800/80">
        ...
        <div className="flex items-center gap-2">
          <button
            id="btn-dash-quick-income"
            onClick={onOpenQuickIncome || onOpenQuickTx}
            className="px-3.5 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-emerald-400 border border-emerald-500/30 text-xs font-semibold shadow-sm transition-all flex items-center gap-1.5"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {/* Ingresos del Mes */}
        <div
          id="kpi-ingresos-card"
          onClick={() => onNavigate && onNavigate('ingresos')}
          className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800/80 shadow-sm cursor-pointer hover:border-emerald-500/40 transition-all group"
          title="Ver desglose detallado de ingresos"
        >
          <div className="flex items-center justify-between text-xs text-slate-400 mb-2">
            <span className="font-medium group-hover:text-emerald-400 transition-colors">Ingresos este mes</span>
            <div className="w-7 h-7 rounded-lg bg-emerald-500/10 flex items-center justify-center text-emerald-400 group-hover:bg-emerald-500/20 transition-colors">
          ...
          <div className="mt-3 flex items-center justify-between text-xs">
            ...
            >
              ...
              <span className="text-slate-400 ml-1 font-normal">vs anterior</span>
            </span>
            <span className="text-emerald-400/80 text-[11px] font-medium group-hover:underline flex items-center gap-0.5">
